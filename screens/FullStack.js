...
const FullStack = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const q = query(collection(db, 'freelancers'), where('specialization', '==', 'Mobile Development'));
  ...
  const FlipCard = ({ user }) => {
    ...
    const sendEmail = () => {
      MailComposer.composeAsync({
        ...
        body: 'Hello, I would like to connect with you regarding your Full Stack Development services.',
      });
    };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Explore & Find the Best Mobile App Developers</Text>
